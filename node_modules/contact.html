...
<html>
	<head>
		<title>Contact-AJ Tyzack & Co</title>
		<meta charset="utf-8" />
	...
	<body>
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header">
									<h1><a href="index.html">AJ Tyjack</a> and Company Limited</h1>
					<nav id="nav">
						<ul>
				...
				<section id="main" class="container 75%">
					...
					<div class="box">
							...
							<h3>Find Us</h3>
								...
								<div class="6u 12u(mobilep)">
								<h3>Contact us</h3>
								<p><Strong>Tel: </strong> 0044 (0)1625 574111</p>
								<p><Strong>Address: </strong>Waters Green House</br>
								Macclesfield</br>
								SK11 6LF</br>
								UK
								</div>
			...
			<!-- Footer -->
				<footer id="footer">
					...
					<ul class="copyright">
						<li>&copy; AJ Tyzack & Co. All rights reserved.</li><li>Design: <a href="http://skyzack.com">Skyzack</a></li><li><a href="privacy.html">Privacy</a></li><li><a href="terms.html">Terms</a></li>
					</ul>
					<ul class="copyright">
...
jQuery(function($) {
    $(document).ready(function() {
        var latlng = new google.maps.LatLng(53.2591651,-2.1227037,19);
